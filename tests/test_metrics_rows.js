...
//
// Imported from format.js. This used to regex the function out of app.js and
// eval it against a hand-written formatBytes stub; it now runs against the
// real formatter the browser uses.
(async () => {
